      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        ...
        <h2 className="max-w-lg mb-6 font-sans text-2xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
          <span className="relative inline-block">
            ...
            <span className="relative">Các</span>
          </span>{" "}
          bước nhận ngay 1000 ly trà sữa miễn phí nhân dịp khai trương
        </h2>
          ...
          <div className="lg:py-6 lg:pr-16">
            ...
            <div className="flex">
              ...
              <div className="pt-1 pb-8">
                ...
                <p className="text-gray-700">
                  Tham gia ngay vào nhóm Zalo để nhận ưu đãi từ{" "}
            ...
            <div className="flex">
              ...
              <div className="pt-1 pb-8">
                ...
                <p className="text-gray-700">
                  ...
                  từ <strong>10h - 12h </strong> trong 3 ngày
                  <strong>01/06 - 03/06 2022</strong> tại địa chỉ
                  <strong> 07 Cô Giang - Hải Châu - Đà Nẵng </strong> để nhận
                  ngay 01 ly{" "}
